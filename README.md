...
- [**Static Code Analysis**](#static-code-analysis) with Aura Helper because implement SFDX Scanner and can run Static Code Analysis of your project to create better applications. Only need to run tthe command `AuraHelper: Scan` on file or folder to scan it and get results on problems panel.
